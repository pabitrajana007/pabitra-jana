    ...
    <div className="projects-container" id="projects">
        ...
        <div className="projects-grid">
            <div className="project">
                <a href="https://devpost.com/software/mlh-movie-recommender" target="_blank" rel="noreferrer"><img src={mock10} className="zoom" alt="thumbnail" width="100%"/></a>
                <a href="https://devpost.com/software/mlh-movie-recommender" target="_blank" rel="noreferrer"><h2>Movie Recommender</h2></a>
